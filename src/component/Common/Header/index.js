        ...
        <div className="offcanvas-mobile-menu-wrapper">
              ...
              <ul>
                    ...
                    <>
                      <ul className="mobile-sub-menu">
                        <li>
                          ...
                          <ul className="mobile-sub-menu">
                            ...
                            <li>
                              <Link to="/shop">Toners & Mists</Link>
                            </li>
                            <li>
                      ...
                      <ul className="mobile-sub-menu">
                        <li>
                          ...
                          <ul className="mobile-sub-menu">
                            <li>
                              <Link to="/shop">Body Bath Oils</Link>
                            </li>
                            <li>
                ...
                <li>
                  ...
                  {show === "feature" ? (
                    <ul className="mobile-sub-menu">
                      <li>
                        <Link to="/shop">Carave</Link>
                      </li>
                      <li>
                        <Link to="/shop">Simple</Link>
                      </li>
                      <li>
                        <Link to="/shop">NEUTROGENA</Link>
                      </li>
                      <li>
                        <Link to="/shop">Skin Aqua</Link>
                      </li>
                      <li>
                        <Link to="/shop">Cosrx</Link>
                      </li>
                      <li>
                        <Link to="/shop">Good Molecules</Link>
                      </li>
                      <li>
                        <Link to="/shop">Topicrem</Link>
                      </li>
          ...
          <div className="mobile-contact-info">
            <div className="logo">
              <Link
                to="/"
                style={{ color: "white", fontSize: "50px", fontWeight: "600" }}
              >
                Ad<span style={{ color: "#e07038" }}>lory</span>
              </Link>
            </div>
            <address className="address">
              {/* <span>Address: Your address goes here.</span> */}
              <span>Call/complaint: 08100069764</span>
              <span>Email: shopwithadlory@gmail.com</span>
            </address>
            <ul className="social-link">
              ...
              <li>
                <a href="https://instagram.com/shopwithadlory?r=nametag">
      ...
      >
        ...
        <div className="mobile-contact-info">
          <address className="address">
            ...
            <Link
              to="/"
              style={{ color: "white", fontSize: "80px", fontWeight: "600" }}
            >
              Adlory
            </Link>
