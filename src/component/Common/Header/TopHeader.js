...
{/*                                      
                                            ...
                                            <li>  <a href="https://instagram.com/shopwithadlory?r=nametag" target='blank'><i className="fa fa-instagram"></i></a></li>
                                            {/* <li>  <a href="#!"><i className="fa fa-facebook"></i></a></li> */}
                                            {/* <li>  <a href="#!"><i className="fa fa-twitter"></i></a></li> */}
                                            <li>  <a href="https://api.whatsapp.com/send/?phone=2348066375807&text=Hello+Doxaglowskincare%2C+My+name+is+__________&type=phone_number&app_absent=0" target='blank'><i className="fa fa-whatsapp"></i></a></li>
                                            <li>  <a href="https://www.facebook.com/shopwithadlory" target='blank'><i className="fa fa-facebook"></i></a></li>
                                        </ul>
                                        :
                                        <ul className="right_list_fix">
