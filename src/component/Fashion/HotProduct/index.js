...
const HotProduct = () => { 
    ...
    <section id="hot_Product_area" className="ptb-100">
        <div className="container">
            <Heading heading="Hot Products" para="See What Everyone Is Shopping from Adlory" />
            <div className="row">
                ...
                <div className="col-lg-12" >
                    <div className="tabs_el_wrapper" >
                        <div className="tab-content" >
                          <div id="new_arrival" className="tab-pane fade show in active new_arrival">
                              <div className="row">
                          ...
                          <div id="trending" className="tab-pane fade  new_arrival" >
                          <div className="row"> 
